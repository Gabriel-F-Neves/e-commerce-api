...
public class PedidoController {
	...
	@GetMapping("/pedido-itempedido")
	public ResponseEntity<List<RelatorioPedidoDTO>> getAllPedido_ItemPedidoDTO(){
		return new ResponseEntity<>(pedidoService.getAllPedido_ItemPedidoDTO(), HttpStatus.OK);	
	}
