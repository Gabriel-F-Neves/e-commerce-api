...
//		produtoExistenteNoBanco.setImagem(produto.getImagem());
	...
	public Produto toEntidadeRelatorio(RelatorioProdutoDTO relatorioProdutoDTO) {
		Produto produto = new Produto();
		
		produto.setIdProduto(relatorioProdutoDTO.getIdProduto());
		produto.setNome(relatorioProdutoDTO.getNomeProduto());
	
		return produto;
	}
	
	public RelatorioProdutoDTO toDTORelatorio(Produto produto) {
